...
export type GetMedicinesGroupByPayload<T extends MedicinesGroupByArgs> = Prisma.PrismaPromise<
  Array<
...
export type MedicinesWhereInput = {
  ...
  stockQuantity?: Prisma.IntFilter<"Medicines"> | number
  imageUrl?: Prisma.StringNullableFilter<"Medicines"> | string | null
...
export type MedicinesScalarWhereWithAggregatesInput = {
  ...
  stockQuantity?: Prisma.IntWithAggregatesFilter<"Medicines"> | number
  imageUrl?: Prisma.StringNullableWithAggregatesFilter<"Medicines"> | string | null
...
export type MedicinesCreateInput = {
  ...
  seller: Prisma.SellerCreateNestedOneWithoutMedicinesInput
...
export type MedicinesUpdateInput = {
  ...
  seller?: Prisma.SellerUpdateOneRequiredWithoutMedicinesNestedInput
...
export type MedicinesOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "name" | "manufacturer" | "price" | "stockQuantity" | "imageUrl" | "sellerId" | "categoryId" | "createdAt" | "updatedAt", ExtArgs["result"]["medicines"]>
...
export interface Prisma__MedicinesClient<T, Null = never, ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
  ...
  orderItems<T extends Prisma.Medicines$orderItemsArgs<ExtArgs> = {}>(args?: Prisma.Subset<T, Prisma.Medicines$orderItemsArgs<ExtArgs>>): Prisma.PrismaPromise<runtime.Types.Result.GetResult<Prisma.$OrderItemPayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>
...
export interface MedicinesFieldRefs {
  ...
  readonly stockQuantity: Prisma.FieldRef<"Medicines", 'Int'>
  readonly imageUrl: Prisma.FieldRef<"Medicines", 'String'>
